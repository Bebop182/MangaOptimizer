...
def erase_rainbow_artifacts(img, is_color, freq_threshold=0.3, target_angle=135, angle_tolerance=10, attenuation_factor=0.10):
    """
    ...
    if is_color and img.mode in ('RGB', 'RGBA'):
        ...
        clean_spectrum = attenuate_diagonal_frequencies(fft_spectrum, freq_threshold, target_angle, angle_tolerance, attenuation_factor)
